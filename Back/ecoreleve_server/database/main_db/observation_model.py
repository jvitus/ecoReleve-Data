...
from ecoreleve_server.core.base_model import HasDynamicProperties, GenericType
from ecoreleve_server.utils.parseValue import isNumeric
from ecoreleve_server.utils.parseValue import formatValue


class Observation(HasDynamicProperties, Main_Db_Base):
    ...
    def getTypeClass(cls):
        if not hasattr(cls, 'TypeClass'):
            class Type(GenericType, Main_Db_Base):
